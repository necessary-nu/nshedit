...
//!
//! C and readline interoperability live in `nshedit-abi`; this crate exposes
//! only safe Rust values and operations.
...
/// Safe editor sessions and their borrowed I/O capabilities.
pub mod editor;

// [spec:nshedit:req:core.history+1]
/// Owned history storage and traversal.
pub mod history;

/// The nshedit and libedit V2 history-file formats.
