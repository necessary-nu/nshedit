...
//! entries become `el_func!(path)` naming the same function names in
//! [`crate::compat::vi`], [`crate::compat::emacs`] and [`crate::compat::common`] (the module is the
//! `.c` file the prototype came from; the macro is the `extern "C"` shim
//! [`crate::compat::map::ElFuncT`] needs), and each `el_func_help[]` row becomes an
...
use crate::compat::map::{ElBindingsT, ElFuncT, el_func};
...
///
/// Each row is wrapped in [`crate::compat::map::el_func!`] because [`ElFuncT`] is the
/// C ABI's shape — an application installs one of its own through
/// `el_set(EL_ADDFN, ...)` — while the commands themselves are ordinary Rust
/// functions taking `&mut EditLine`. The macro is the `extern "C"` shim
/// between the two; the generator's output still names each command exactly
/// once, in exactly this order.
pub(crate) static EL_FUNC: [ElFuncT; EL_NUM_FCNS] = [
    el_func!(crate::compat::common::ed_argument_digit),
    el_func!(crate::compat::common::ed_clear_screen),
    el_func!(crate::compat::common::ed_command),
    el_func!(crate::compat::common::ed_delete_next_char),
    el_func!(crate::compat::common::ed_delete_prev_char),
    el_func!(crate::compat::common::ed_delete_prev_word),
    el_func!(crate::compat::common::ed_digit),
    el_func!(crate::compat::common::ed_end_of_file),
    el_func!(crate::compat::common::ed_ignore),
    el_func!(crate::compat::common::ed_insert),
    el_func!(crate::compat::common::ed_kill_line),
    el_func!(crate::compat::common::ed_move_to_beg),
    el_func!(crate::compat::common::ed_move_to_end),
    el_func!(crate::compat::common::ed_newline),
    el_func!(crate::compat::common::ed_next_char),
    el_func!(crate::compat::common::ed_next_history),
    el_func!(crate::compat::common::ed_next_line),
    el_func!(crate::compat::common::ed_prev_char),
    el_func!(crate::compat::common::ed_prev_history),
    el_func!(crate::compat::common::ed_prev_line),
    el_func!(crate::compat::common::ed_prev_word),
    el_func!(crate::compat::common::ed_quoted_insert),
    el_func!(crate::compat::common::ed_redisplay),
    el_func!(crate::compat::common::ed_search_next_history),
    el_func!(crate::compat::common::ed_search_prev_history),
    el_func!(crate::compat::common::ed_sequence_lead_in),
    el_func!(crate::compat::common::ed_start_over),
    el_func!(crate::compat::common::ed_transpose_chars),
    el_func!(crate::compat::common::ed_unassigned),
    el_func!(crate::compat::emacs::em_capitol_case),
    el_func!(crate::compat::emacs::em_copy_prev_word),
    el_func!(crate::compat::emacs::em_copy_region),
    el_func!(crate::compat::emacs::em_delete_next_word),
    el_func!(crate::compat::emacs::em_delete_or_list),
    el_func!(crate::compat::emacs::em_delete_prev_char),
    el_func!(crate::compat::emacs::em_exchange_mark),
    el_func!(crate::compat::emacs::em_gosmacs_transpose),
    el_func!(crate::compat::emacs::em_inc_search_next),
    el_func!(crate::compat::emacs::em_inc_search_prev),
    el_func!(crate::compat::emacs::em_kill_line),
    el_func!(crate::compat::emacs::em_kill_region),
    el_func!(crate::compat::emacs::em_lower_case),
    el_func!(crate::compat::emacs::em_meta_next),
    el_func!(crate::compat::emacs::em_next_word),
    el_func!(crate::compat::emacs::em_set_mark),
    el_func!(crate::compat::emacs::em_toggle_overwrite),
    el_func!(crate::compat::emacs::em_universal_argument),
    el_func!(crate::compat::emacs::em_upper_case),
    el_func!(crate::compat::emacs::em_yank),
    el_func!(crate::compat::vi::vi_add),
    el_func!(crate::compat::vi::vi_add_at_eol),
    el_func!(crate::compat::vi::vi_alias),
    el_func!(crate::compat::vi::vi_change_case),
    el_func!(crate::compat::vi::vi_change_meta),
    el_func!(crate::compat::vi::vi_change_to_eol),
    el_func!(crate::compat::vi::vi_command_mode),
    el_func!(crate::compat::vi::vi_comment_out),
    el_func!(crate::compat::vi::vi_delete_meta),
    el_func!(crate::compat::vi::vi_delete_prev_char),
    el_func!(crate::compat::vi::vi_end_big_word),
    el_func!(crate::compat::vi::vi_end_word),
    el_func!(crate::compat::vi::vi_histedit),
    el_func!(crate::compat::vi::vi_history_word),
    el_func!(crate::compat::vi::vi_insert),
    el_func!(crate::compat::vi::vi_insert_at_bol),
    el_func!(crate::compat::vi::vi_kill_line_prev),
    el_func!(crate::compat::vi::vi_list_or_eof),
    el_func!(crate::compat::vi::vi_match),
    el_func!(crate::compat::vi::vi_next_big_word),
    el_func!(crate::compat::vi::vi_next_char),
    el_func!(crate::compat::vi::vi_next_word),
    el_func!(crate::compat::vi::vi_paste_next),
    el_func!(crate::compat::vi::vi_paste_prev),
    el_func!(crate::compat::vi::vi_prev_big_word),
    el_func!(crate::compat::vi::vi_prev_char),
    el_func!(crate::compat::vi::vi_prev_word),
    el_func!(crate::compat::vi::vi_redo),
    el_func!(crate::compat::vi::vi_repeat_next_char),
    el_func!(crate::compat::vi::vi_repeat_prev_char),
    el_func!(crate::compat::vi::vi_repeat_search_next),
    el_func!(crate::compat::vi::vi_repeat_search_prev),
    el_func!(crate::compat::vi::vi_replace_char),
    el_func!(crate::compat::vi::vi_replace_mode),
    el_func!(crate::compat::vi::vi_search_next),
    el_func!(crate::compat::vi::vi_search_prev),
    el_func!(crate::compat::vi::vi_substitute_char),
    el_func!(crate::compat::vi::vi_substitute_line),
    el_func!(crate::compat::vi::vi_to_column),
    el_func!(crate::compat::vi::vi_to_history_line),
    el_func!(crate::compat::vi::vi_to_next_char),
    el_func!(crate::compat::vi::vi_to_prev_char),
    el_func!(crate::compat::vi::vi_undo),
    el_func!(crate::compat::vi::vi_undo_line),
    el_func!(crate::compat::vi::vi_yank),
    el_func!(crate::compat::vi::vi_yank_end),
    el_func!(crate::compat::vi::vi_zero),
];
