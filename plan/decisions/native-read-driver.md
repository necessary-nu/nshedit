...
scope {
    ...
    rules ([spec:nshedit:req:core.read-driver] [spec:nshedit:req:core.effect-hooks] [spec:nshedit:req:core.line-commands] [spec:nshedit:req:core.command-effects])
}
...
edges {
    ...
    related_to ([dec:libedit:opaque-abi-adapter] [dec:libedit:platform-layer] [dec:libedit:lint-policy])
}
codifies ([spec:nshedit:req:core.read-driver] [spec:nshedit:req:core.command-effects])
---
