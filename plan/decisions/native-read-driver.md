...
scope {
    ...
    rules ([spec:nshedit:req:core.read-driver] [spec:nshedit:req:core.effect-hooks] [spec:nshedit:req:core.line-commands])
}
...
codifies ([spec:nshedit:req:core.read-driver])
---
